...
const I18N = {
  ...
  pt: {
    ...
    credits: {
      ...
      creators_label: 'criação',
      creators: ['Fernanda Diniz', 'Grazielli Diniz', 'Joana Diniz', 'Kaio Diniz', 'Stephanie Diniz', 'Ricardo Poli', 'Edison Miranda'],
