...
const I18N = {
  ...
  pt: {
    ...
    credits: {
      label: 'Créditos',
      subtitle: 'a última fagulha · 9 capítulos · 14 faixas · ≈ 22h',
      game_label: 'concepção · código · direção',
      game_value: '—',
      music_label: 'trilha sonora',
      music_value: '—',
      assist_label: 'programação assistida',
      assist_value: 'Claude (Anthropic)',
      thanks: 'obrigado por escutar até o fim.',
    },
    menu: {
  ...
  en: {
    ...
    credits: {
      label: 'Credits',
      subtitle: 'the last spark · 9 chapters · 14 tracks · ≈ 22h',
      game_label: 'design · code · direction',
      game_value: '—',
      music_label: 'soundtrack',
      music_value: '—',
      assist_label: 'assisted by',
      assist_value: 'Claude (Anthropic)',
      thanks: 'thank you for listening to the end.',
    },
    menu: {
  ...
  es: {
    ...
    credits: {
      label: 'Créditos',
      subtitle: 'la última chispa · 9 capítulos · 14 pistas · ≈ 22h',
      game_label: 'concepción · código · dirección',
      game_value: '—',
      music_label: 'banda sonora',
      music_value: '—',
      assist_label: 'asistencia',
      assist_value: 'Claude (Anthropic)',
      thanks: 'gracias por escuchar hasta el final.',
    },
    menu: {
